...
```{r setting the global environment,echo=TRUE,results="hide"}
...
library(ggplot2)
library(lubridate)
## Get our Session Info for reproducibility
sessionInfo()
```
...
So, we can see that 8:35-8:39am is the most active time when averaged over the time period with approximately 206 steps per day in the 5 min period. 
